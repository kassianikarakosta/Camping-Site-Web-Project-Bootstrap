...
export let doSignUp = async (req, res) => {
    try {
        const { username, password, email, first_name, last_name, phone, id_number, birth_date, user_type, city, street_name, street_num, post_code } = req.body;
        ...
        await pool.query(
            ...
            [first_name, last_name, username, hashedPassword, email, phone, id_number, birth_date, user_type, city, street_name, street_num, post_code]
        );
