...
export let doSignUp = async (req, res) => {
    try {
        const { firstname, lastname, username, user_password, email, phone, idnumber, birthdate, user_type, city, streetname, streetnum, postcode } = req.body;
        ...
        await pool.query(
            ...
            [firstname, lastname, username, user_password, email, phone, idnumber, birthdate, user_type, city, streetname, streetnum, postcode]
        );
